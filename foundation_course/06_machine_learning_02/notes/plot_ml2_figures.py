...
palette and registry in ``figures/core.py``. Run with the repo virtualenv:
    ...
    cd foundation_course/06_machine_learning_02/notes && ../../../.venv/bin/python plot_ml2_figures.py

Pass figure names to rebuild only some of them:

    ../../../.venv/bin/python plot_ml2_figures.py entropy_curve gini_vs_entropy
"""
